...
- (instancetype)initWithSocksProxyData:(NSData *)socksProxyData networkSettingsData:(NSData *)networkSettingsData
{
    ...
    if (self != nil)
    {
        ...
        //链接vpn
        apiEnvironment = [apiEnvironment withUpdatedSocksProxySettings:[[MTSocksProxySettings alloc] initWithIp:@"127.0.0.1" port:1081 username:nil password:nil secret:nil]];
