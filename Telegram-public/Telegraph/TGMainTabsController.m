...
- (instancetype)initWithFrame:(CGRect)frame presentation:(TGPresentation *)presentation
{
    ...
    if (self != nil)
    {
        ...
        NSString * settingTitle = [effectiveLocalization().code isEqualToString:@"en"] ? @"Settings" : TGLocalized(@"Settings.TabTitle");
        ...
        _settingsButton = [[TGTabBarButton alloc] initWithImage:presentation.images.tabBarSettingsIcon title:settingTitle presentation:presentation];
