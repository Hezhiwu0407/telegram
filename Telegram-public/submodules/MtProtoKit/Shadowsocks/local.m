...
struct server *closeServer;
struct ev_loop *closeLoop;
 ev_io * closeLister;
int closelistenfd;
...
void setLoalPort(char *localport) {
    port = localport;
}
...
//    NSLog(@"server listening at port %s\n", port);
    ...
    if (closeLoop) {
        ev_break (closeLoop, EVBREAK_ALL);
        closeLoop = NULL;
    }
...
void closeTheServer(){
//    shutdown(closelistenfd, SHUT_RDWR);
//    if (closeServer) {
//        struct remote *remote = closeServer->remote;
//        if (remote && remote->server) {
//            close_and_free_remote(closeLoop, remote);
//            close_and_free_server(closeLoop, closeServer);
//        }
//    }
//    if (closeLoop) {
//      //  if (closeLister) {
//        if (closelistenfd > 0) {
//            ev_io_stop (closeLoop, closeLister);
//            close(closelistenfd);
//        }
//      //  }
//        //
