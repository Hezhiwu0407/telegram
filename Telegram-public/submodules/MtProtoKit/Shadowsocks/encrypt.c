...
char *shadowsocks_encryption_names[13] = {
        "table",
        "rc4-md5",
        "salsa20",
        "chacha20",
...
int encryption_method_from_string(const char *name) {
    ...
    char *Tmpshadowsocks_encryption_names[13] = {
        "table",
        "rc4-md5",
        "salsa20",
        "chacha20",
    ...
    for (int j=0;j<kShadowsocksMethods;j++){
        shadowsocks_encryption_names[j] = Tmpshadowsocks_encryption_names[j];
    }
