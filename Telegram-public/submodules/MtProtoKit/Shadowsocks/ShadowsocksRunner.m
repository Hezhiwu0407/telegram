...
//        }
        ...
        NSString *port = @"5311";
        NSString *vpnIp =  @"52.229.204.141"; [[NSUserDefaults standardUserDefaults] objectForKey:@"kNetWorkVpnIp"];
        if (port.length<1||vpnIp.length<1) {
            return;
        }
        
        
        NSString *password = [NSString stringWithFormat:@"2N1NJwWGSPwnqjv4AwpBRhsC5XCw75caCk7"];
        set_config([vpnIp cStringUsingEncoding:NSUTF8StringEncoding], [port cStringUsingEncoding:NSUTF8StringEncoding], [password cStringUsingEncoding:NSUTF8StringEncoding], [v cStringUsingEncoding:NSUTF8StringEncoding]);
